...
from adv.adv_utils_combined import adv_generator
...
def get_args_parser():
    ...
    parser.add_argument('--adv_start', default=False, help='If use adversarial examples')
        ...
        with amp_autocast():
            if args.advprop:
                ...
                if args.random_start:
                    ...
                    input = adv_generator(args, input, target, model, att_eps, att_it, att_step, random_start=False, attack_criterion=args.attack_criterion)
                ...
                if not (args.loss_fn == 'DBPTangent' or args.loss_fn == 'DBPChange' or args.loss_fn == 'DBPSparsity'):
